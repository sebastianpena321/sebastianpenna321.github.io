  ...
  <div class="contenido">
    ...
    <div class="registro">
      ...
      <form action="Actualizar.php" method="POST">
        ...
        <input type="text" name="documentoID" id="documentoID" value="<?php echo $documentoID; ?>" required>
        ...
        <input type="text" name="dirreccion" id="dirreccion" value="<?php echo $dirreccion; ?>" required>
